...
public class Registration extends Activity  implements AdapterView.OnItemSelectedListener{
    ...
    EditText Ename , Emobile, Eemail, Eage, Epassword;
    TextView signup;
    Button signin;
    FirebaseAuth firebaseAuth;
    Spinner Egender;
    String name, email, password, age, mobile, gen;
    ...
    public void sendUserData(){
        ...
        UserProfile userProfile = new UserProfile(name, email,age,mobile, gen);
    ...
    private void sendEmailVerification(){
        ...
        if(firebaseUser1 != null){
            firebaseUser1.sendEmailVerification().addOnCompleteListener(task -> {
                if ( task.isSuccessful()){
                    sendUserData();
                    Toast.makeText(Registration.this, "Verification link is send to your Email-id", Toast.LENGTH_SHORT).show();
